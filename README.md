## 🌟 Aditya Bhardwaj's Netflix-inspired Portfolio 🌟

Welcome to my personal portfolio project! 🚀 This website showcases my work, skills, and experiences as a backend developer. It's designed to be lightweight, customizable, and professional while maintaining an approachable style.

You can deploy this portfolio under any domain you like (for example, a personal `.com` or a subdomain dedicated to your work).
